...
\subsubsection{\kom{set} Funktionen}
\lstinputlisting[language=Python, firstline=47, lastline=64]{SubTex/Code/DatenTypen.py}
...
\subsubsection{\kom{Dictionary} Funktionen}
...
\lstinputlisting[language=Python, firstline=73, lastline=74]{SubTex/Code/DatenTypen.py}
Jedoch gibt diese Art vom addressieren einen Key-Error. Besser ist die get-Funktion.

\lstinputlisting[language=Python, firstline=76, lastline=76]{SubTex/Code/DatenTypen.py}
